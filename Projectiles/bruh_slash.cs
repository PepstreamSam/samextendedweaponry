...
{
    class bruh_slash : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Main.PlaySound(16, (int)projectile.Center.X, (int)projectile.Center.Y, 1);
            ...
            {                                           // use of this projectile... Like stated earlier: this is just to make things pretty).     
                int num30 = Dust.NewDust(vector14 - projectile.Size / 2f, projectile.width, projectile.height, 92, projectile.velocity.X, projectile.velocity.Y, 100, default(Color), 2f);
            ...
            projectile.position = player.RotatedRelativePoint(player.MountedCenter, true) - projectile.Size / 2.5f; // Set the position of the Arkhalis projectile, based on the 'Scale' vector.
