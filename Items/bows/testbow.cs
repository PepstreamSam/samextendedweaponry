...
namespace samextendedweaponry.Items.bows
{
	public class testbow : ModItem
	{
		...
		{
			DisplayName.SetDefault("Great Alloy Smallbow"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("shoots rockets when normal arrows used");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				type = ProjectileID.RocketFireworksBoxBlue; // or ProjectileID.FireArrow;
			}
			return true;
		}
