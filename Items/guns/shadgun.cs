...
{
	public class shadgun : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Shaded Blaster"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("Ichourous (turns bullets into ichor bullets).");
		}
