...
namespace samextendedweaponry.Items.guns
{
	public class raygun : ModItem
	{
		...
		{
			DisplayName.SetDefault("Rayfle"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("shoots gravity affected rays that pierces four times.");
		}
		...
		public override void SetDefaults() {
			...
			item.UseSound = SoundID.Item124; // The sound that this item plays when used.
			item.autoReuse = true; // if you can hold click to automatically use it again
			item.shoot = 10; //id why but all the guns in the vanilla source have this
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				type = ProjectileID.MoonlordArrowTrail; // or ProjectileID.FireArrow;
			}
