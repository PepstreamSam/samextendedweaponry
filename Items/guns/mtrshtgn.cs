...
{
	public class mtrshtgn : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Meteoric Attacker"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("it (doesn't) comes from outer space (turns normal bullets into meteor shot).");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				type = ProjectileID.MeteorShot; // or ProjectileID.FireArrow;
