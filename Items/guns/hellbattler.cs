...
{
	public class hellbattler : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Battler of hell"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("shoots a three bullet burst (66% chance of consume ammo ).");
		}
		...
		public override void SetDefaults() {
			...
			item.scale = 1.001f; //would be 25 % bigger
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			type = Main.rand.Next(new int[] { type, ProjectileID.ExplosiveBullet, ProjectileID.HellfireArrow, });
			return true;
		}
