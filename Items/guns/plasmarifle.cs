...
namespace samextendedweaponry.Items.guns
{
	public class plasmarifle : ModItem
	{
		...
		{
			DisplayName.SetDefault("Boltstorm"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("Sadly you can't dual wield use it , or can you?.");
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<plasmagun>(), 1);
