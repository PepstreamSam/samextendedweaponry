...
{
	public class zbasegun : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("basegun"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
