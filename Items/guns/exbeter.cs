...
{
	public class exbeter : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Vortex Spectre"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("Hey beeter shoots a barrage of bees vortex rockets homing ghosts and lasers no need to aim :).");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				type = ProjectileID.LostSoulFriendly; // or ProjectileID.FireArrow;
			}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<hallowedgun>(), 1);
