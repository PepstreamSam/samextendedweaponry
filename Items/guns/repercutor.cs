...
{
	public class repercutor : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Repercutor"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("the bringer of justice in cruel world.");
		}
