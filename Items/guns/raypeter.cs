...
{
	public class raypeter : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Magnetiryzer"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("Big blue magnetic balls.");
		}
		...
		public override void SetDefaults() {
			...
			item.UseSound = SoundID.Item109; // The sound that this item plays when used.
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				type = ProjectileID.MagnetSphereBolt; // or ProjectileID.FireArrow;
			}
