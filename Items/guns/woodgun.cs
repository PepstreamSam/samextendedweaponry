...
namespace samextendedweaponry.Items.guns
{
	public class woodgun : ModItem
	{
		...
		{
			DisplayName.SetDefault("Hand Made Handgun"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("leafy(turns bullets into leafs.");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				type = ProjectileID.Leaf; // or ProjectileID.FireArrow;
			}
			return true;
		}
