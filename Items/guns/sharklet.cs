...
{
	public class sharklet : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Sharklet"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault(".");
		}
