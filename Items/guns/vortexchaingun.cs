...
{
	public class vortexchaingun : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Vortex Chain Gun"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("Fires a barrage of bullets and vortex rockets.");
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ItemID.FragmentVortex, 22);
