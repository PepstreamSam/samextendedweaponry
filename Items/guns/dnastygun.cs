...
{
	public class dnastygun : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Dinasted Shredder"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("Speed(turns bullets into high velocity bullets).");
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ItemID.DynastyWood, 50);
