...
{
	public class junglgun : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Mossy Blaster"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("Venom arghhh(turns bullets into venom bullets).");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				type = ProjectileID.VenomBullet; // or ProjectileID.FireArrow;
			}
