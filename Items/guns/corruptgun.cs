...
namespace samextendedweaponry.Items.guns
{
	public class corruptgun : ModItem
	{
		...
		{
			DisplayName.SetDefault("Pulsket"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("Average Musket enjoyer.");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			type = Main.rand.Next(new int[] { type, ProjectileID.ExplosiveBullet, ProjectileID.EatersBite });
