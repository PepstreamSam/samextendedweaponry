...
{
	public class theprototype : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("The Prototype"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("The son of the mother.");
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ItemID.BeetleHusk, 50);
