...
{
	public class plasmarevolver : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Plasma Revolver"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("Don't touch the barrel cus' it's HOT.");
		}
		...
		public override void SetDefaults() {
			...
			item.UseSound = mod.GetLegacySoundSlot(SoundType.Item,"Sounds/bang"); // The sound that this item plays when used.
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			int numberProjectiles = 10 + Main.rand.Next(3); // 4 or 5 shots
