...
{
	public class vortexchainbuster : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Vortex Chain Buster"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("*satisfaction* shoots a barrage of vortex rockets and bullets that end your enemies.");
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<vortexchaingun>(), 1);
			recipe.AddIngredient(ModContent.ItemType<theripper>(), 1);
			Mod CalamityMod = ModLoader.GetMod("CalamityMod");
			if (CalamityMod != null)
			{
				recipe.AddIngredient(CalamityMod.ItemType("RuinousSoul"),10);
				recipe.AddIngredient(CalamityMod.ItemType("BloodstoneCore"), 12);
			}
