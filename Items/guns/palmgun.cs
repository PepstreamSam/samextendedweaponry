...
{
	public class palmgun : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Beach Chain gun"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("Wet(turns bullet into water streams).");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				type = ProjectileID.WaterStream; // or ProjectileID.FireArrow;
			}
			{
