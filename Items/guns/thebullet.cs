...
{
	public class thebullet : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("The Bullet"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("Ridicoulous as funny and effective.");
		}
