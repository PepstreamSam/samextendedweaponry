...
{
	public class pearlgun : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Pearled rifle"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("Bless(turns bullets into.");
		}
		...
		public override void SetDefaults() {
			...
			item.shoot = 10; //idk why but all the guns in the vanilla source have thi
