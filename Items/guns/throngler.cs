...
{
	public class throngler : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Throngler"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("You don't want to be THRONGELERED.");
		}
