...
{
	public class crimsongun : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Gausstaker"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display
			Tooltip.SetDefault("The cooler daniel.");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			type = Main.rand.Next(new int[] { type, ProjectileID.ExplosiveBullet, ProjectileID.VampireKnife });
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<redrifle>(), 1);
